...
class ResponseBox():
    ...
    def __init__(self, root, bg="#FFEFD5", x=800, y=150, width=75, height=25):
        ...
        label = tk.Label(self.root, text="Response",
        ...
        tk.Label(self.root, bg="lightgrey", fg="black",
        text="Send").place(
        bordermode="outside",
        relx=0.5,
        anchor="center",
        ...
        tk.Button(self.root,
        text=">>", fg="black", bd=3,
        width=10, height=0, relief="raised",
        command=self.response_button_command).place(
        bordermode="outside",
        relx=0.5,
        anchor="center",
        y=400)
        ...
        tk.Button(self.root,
        text="Clear",
        bg=self.button_bg, fg="black").place(
        relx=0.5,
        y=710)
